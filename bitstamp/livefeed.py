...
class LiveTradeFeed(barfeed.BaseBarFeed):
    ...
    :param instrument: Which instrument to pass on
    :type instrument: str.
    ...
    def __initializeClient(self):
        ...
        try:
            ...
            self.__thread = self.buildWebSocketClientThread(self.__instrument.lower(), self.__currency.lower())
            self.__thread.start()
    ...
    def __onTrade(self, trade):
        ...
        barDict = {
            self.__instrument: TradeBar(self.__getTradeDateTime(trade), trade)
            }
