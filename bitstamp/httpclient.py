...
class AccountBalance(object):
    ...
    def getCurrencyAvailable(self, currency):
        return float(self.__jsonDict[currency.lower() + "_available"])

    def getCoinAvailable(self, instrument):
        return float(self.__jsonDict[instrument.lower() + "_available"])
...
class UserTransaction(object):
    ...
    def getCoin(self, instrument):
        return float(self.__jsonDict[instrument.lower()])

    def getCoinCurrency(self, instrument, currency):
        return float(self.__jsonDict[instrument.lower() + "_" + currency.lower()])
